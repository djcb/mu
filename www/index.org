...
** News
   ...
   - 2010-04-12 *mu 0.9.4*: adds the =cfind= command, to find contacts (name +
     e-mail), add =flag:unread= which is a synonym for =flag:new OR NOT
     flag:seen=. Updates to the documentation and some internal updates. This is
     a *bèta-version*.
